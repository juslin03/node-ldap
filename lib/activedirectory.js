...
function getUserQueryFilter(username) {
  ...
  var self = this;
  if (!username) return('|(objectCategory=User)(objectclass=*)');
  if (isDistinguishedName.call(self, username)) {
    return('(&(|(objectCategory=User)(objectclass=*))(distinguishedName='+parseDistinguishedName(username)+'))');
  }
  return('(&(|(objectCategory=User)(objectclass=*))(|(sAMAccountName='+username+')(userPrincipalName='+username+')(uid='+username+')(mail='+username+')))');
}
