...
function getUserQueryFilter(username) {
  ...
  var self = this;
  if (!username) return('|(objectCategory=User)(objectClass=User)');
  if (isDistinguishedName.call(self, username)) {
    return('(&(|(objectCategory=User)(objectClass=User))(distinguishedName='+parseDistinguishedName(username)+'))');
  }
  return('(&(|(objectCategory=User)(objectClass=User))(|(sAMAccountName='+username+')(userPrincipalName='+username+')(uid='+username+')(mail='+username+')))');
}
