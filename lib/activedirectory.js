...
function getGroupMembershipForDN(opts, dn, stack, callback) {
  ...
  console.log(uidExist, parseDistinguishedName(dn))
  const uidOK = uidExist ? uidExist.split('uid=')[1] : `member=${parseDistinguishedName(dn)}`;
  ...
  console.log(opts, dn, parseDistinguishedName(dn))
